...
#    header = os.path.basename(dir)
    ...
    print(Template(INDEX_TEMPLATE).render(dirnames=dirnames,filenames=filenames, header="SHITCP ARCHIVE INDEX",ROOTDIR=rootdir,time=time.ctime(os.path.getctime(dir))),file=f)
    f.close()
